...
from tensorflow.keras.layers import SimpleRNN, LSTM, GRU, Dropout, Dense, Input, Embedding, Bidirectional
...
tf.keras.utils.plot_model(model_Bidirectional_LSTM, to_file='Bidirectional_LSTM_model.png')
...
model_Bidirectional_LSTM_history = model_Bidirectional_LSTM.fit(train_sentences,
                                                  train_labels,
                                                  epochs=200,
...
# Check the results
model_Bidirectional_LSTM.evaluate(val_sentences, val_labels)

# Predictions
model_Bidirectional_LSTM_pred_probs = model_Bidirectional_LSTM.predict(val_sentences)
model_Bidirectional_LSTM_preds = tf.squeeze(tf.round(model_Bidirectional_LSTM_pred_probs))
model_Bidirectional_LSTM_preds[:20]

model_Bidirectional_LSTM_results = calculate_results(y_true=val_labels,
...
model_results = pd.DataFrame({"baseline": baseline_results,
                              "LSTM_model": model_Bidirectional_LSTM_results})
